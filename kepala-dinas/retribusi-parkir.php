                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-100 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6">Denda (2%)</th> <th class="py-3 px-6">Imbal Jasa (40%)</th> <th class="py-3 px-6 text-center">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            while ($row = mysqli_fetch_assoc($result)):
                                ...
                                <tr class="row-utama" onclick="togglePembantu(<?= $id_utama; ?>)">
                                    ...
                                    <td class="<?= ($persen >= 100) ? 'text-success' : (($persen >= 65) ? 'text-warning' : 'text-danger'); ?> font-bold">
                                        <?= $persen; ?>%
                                    </td>
                                ...
                                <tr id="pembantu-<?= $id_utama; ?>" class="row-pembantu" style="display: none;">
                                    <td></td>
                                    <td colspan="7"> <div class="pembantu-container">
                                            <?php if ($jumlah_pembantu > 0): ?>
