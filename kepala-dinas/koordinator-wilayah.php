    ...
    <div id="modalKorwil" class="modal-backdrop" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h3 id="modalTitle" style="margin: 0; font-size: 1.1rem; font-weight: 700;">Tambah Koordinator Wilayah
                </h3>
            </div>
            <form id="formKorwil" action="../store/proses_korwil.php?action=add" method="POST">
                ...
                <div class="modal-body">
                    <div style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="wilayah" id="wilayah" class="form-input" required
