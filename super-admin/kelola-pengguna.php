...
<body class="font-sans text-slate-800 antialiased min-h-screen pt-24"
    ...
    <main class="container mx-auto" style="max-width:1400px;">
        ...
        <script>
            ...
            // Fungsi pembantu untuk merender opsi dropdown secara dinamis
            function renderRoleOptions(selectedRole = '') {
                // 1. Kembalikan ke kondisi default (hanya ada Admin)
                roleSelect.innerHTML = `<option value="admin">Admin</option>
                                        <option value="super-admin">Super Admin</option>`;

                // 2. LOGIKA: Jika role yang sedang diedit/ditambahkan adalah 'kepala-dinas' atau 'bendahara'
                // Atau jika Anda ingin opsi ini selalu muncul saat tambah user baru, sesuaikan kondisinya
                if (selectedRole === 'kepala-dinas' || selectedRole === 'bendahara') {

                    // Buat opsi Kepala Dinas
                    const optKepala = document.createElement('option');
                    optKepala.value = 'kepala-dinas';
                    optKepala.innerText = 'Kepala Dinas';
                    roleSelect.appendChild(optKepala);

                    // Buat opsi Bendahara
                    const optBendahara = document.createElement('option');
                    optBendahara.value = 'bendahara';
                    optBendahara.innerText = 'Bendahara';
                    roleSelect.appendChild(optBendahara);
                }

                // 3. Set nilai dropdown sesuai dengan data yang dipilih
                roleSelect.value = selectedRole || 'admin';
            }
            ...
            function openAddModal() {
                ...
                // Saat tambah baru, render opsi default (hanya admin)
                renderRoleOptions('');
            ...
            function openEditModal(data) {
                ...
                // PENTING: Render opsi berdasarkan role user yang sedang diedit
                renderRoleOptions(data.role);
