            ...
            <div class="detail-container">
                <div class="header-section">
                    <div class="header-title-box">
                        <a href="../super-admin/retribusi-parkir.php" class="btn-back"><i class="fas fa-arrow-left"></i></a>
        ...
        <div class="modal-content">
            ...
            <form action="../store/proses_retribusi.php" method="POST" class="modal-form">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tanggal_setoran" id="edit_tanggal" required>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="jumlah_setoran" id="edit_nominal" placeholder="0" required>
                    </div>
                </div>
