    ...
    <script>
        ...
        function hapusJukir(type, id, nama) {
            ...
            let warningText = type === 'utama' ?
                `Apakah Anda yakin ingin menghapus <b>${nama}</b>?<br><br><span style="color:#ef4444;">Peringatan: Seluruh Petugas Parkir Pembantu yang terkait juga akan ikut terhapus!</span>` :
