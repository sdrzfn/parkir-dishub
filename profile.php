                    ...
                    <form action="store/proses_profile.php" method="POST" enctype="multipart/form-data"
                        ...
                        <div style="display: flex; align-items: flex-end; gap: 20px; margin-bottom: 30px;">
                            ...
                            <div style="padding-bottom: 10px;">
                                <h3 style="margin: 0; font-size: 1.2rem; color: #1e1b4b; font-weight: 700;"><?= $user['nama']; ?></h3>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 25px;">
                            ...
                            <div class="form-group">
                                <label>Password Baru <small style="color:#94a3b8; font-weight:400;">(Kosongkan jika tidak ganti)</small></label>
                                <input type="password" name="password" placeholder="••••••••" class="form-control">
                            </div>
                        </div>

                        <div style="margin-top: 2rem; border-top: 1px solid #f1f5f9; padding-top: 1.5rem; display: flex; justify-content: flex-end; gap: 12px;">
